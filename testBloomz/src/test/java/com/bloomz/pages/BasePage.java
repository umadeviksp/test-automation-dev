...
public abstract class BasePage {
  ...
  public BasePage swipeRight(String id, int offset, int duration) {
    MobileElement element1 = (MobileElement) appiumDriver.findElementById(id);
    int offset1 = 1;
  ...
  public BasePage swipeLeft(String id, int duration) {
    ...
    appiumDriver.swipe(location.getX() + size.getWidth() - offset, p.getY(), location.getX()
        + offset, p.getY(), 1000);
    return this;
  }
  ...
  public ArrayList<String> getListContents(By locator) {
    java.util.List<WebElement> findElements = appiumDriver.findElements(locator);
