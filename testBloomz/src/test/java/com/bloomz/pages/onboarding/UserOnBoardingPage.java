...
public class UserOnBoardingPage extends BasePage {
   ...
   */
  public UserOnBoardingFlow onBoardUser(String userType, String firstName, String lastName,
      String emailId, String password, String zipCode) {
    Assert.assertTrue(getText(pageTitleLocator).equals(userType), "Current page is not " + userType
        + " onboarding page, Its " + getText(pageTitleLocator) + " onboarding page");
