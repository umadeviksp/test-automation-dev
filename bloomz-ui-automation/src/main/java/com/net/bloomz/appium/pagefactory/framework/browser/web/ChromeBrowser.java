...
import com.net.bloomz.appium.pagefactory.framework.actions.ChromeSeleniumActions;
...
public class ChromeBrowser extends WebBrowser {
	...
	public DesiredCapabilities getDesiredCapabilities() {
		...
		// If the browser binary path is present and not empty, then set this as
		...
		// This eliminates the banner with the message
