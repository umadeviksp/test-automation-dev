 ...
 * <p>
 * <p>
 * Use TimeoutsConfig.builder() to get a Builder that begins with default timeout values. Then call
 * builder.build() to get a finalized TimeoutsConfig instance.
 * </p>
 *
 * @see TimeoutType
 */
public final class TimeoutsConfig {
  ...
  private TimeoutsConfig(int clickTimeoutSeconds, int webElementPresenceTimeoutSeconds,
      ...
      int mediumTimeoutSeconds, int longTimeoutSeconds, int pauseBetweenKeysMillis,
      int pauseBetweenTriesMillis, int pauseBetweenRefreshSeconds, int pageLoadTimeoutSeconds,
      int implicitWaitTimeoutMillis) {
  ...
  /**
   * Return a Builder for constructing a TimeoutsConfig instance. The Builder is populated with
   * default timeouts, and you can modify them as desired, then call builder.build().
   *
   * @return - a {@link com.net.bloomz.appium.pagefactory.framework.config.TimeoutsConfig.Builder}
   */
   ...
   * <p>
   * It doesn't make sense to pass in the DEFAULT timeout type, because that is a context-sensitive
   * timeout.
   *
  ...
  public static final class Builder {
    ...
    public TimeoutsConfig build() {
      return new TimeoutsConfig(clickTimeoutSeconds, webElementPresenceTimeoutSeconds,
          ...
          mediumTimeoutSeconds, longTimeoutSeconds, pauseBetweenKeysMillis,
          pauseBetweenTriesMillis, pauseBetweenRefreshSeconds, pageLoadTimeoutSeconds,
    ...
    /**
     * Set the pause between tries in milliseconds. This is used for pausing between checks to see
    ...
    /**
     * Set the pause between refreshing the page when polling for something to be present by
     * refreshing the page repeatedly.
     *
    ...
    /**
     * Set the timeout waiting for a new page to load in the web browser. This is both used by the
     * framework and passed on to the Selenium WebDriver for its configuration.
     *
    ...
    /**
     * Set the implicit wait timeout for checking if a web element is present. This is used when
     * configuring a Selenium WebDriver.
     *
