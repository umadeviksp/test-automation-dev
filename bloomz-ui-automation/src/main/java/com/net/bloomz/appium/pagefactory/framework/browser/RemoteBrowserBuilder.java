 ...
 * <p>
 * <p>
 * In other words, a RemoteBrowser is a wrapper around a
 * {@link org.openqa.selenium.remote.RemoteWebDriver} that simplifies
 * configuration and unifies options across all Browsers.
 * </p>
 * <p>
 * <p>
 * You can call {@link #getBuilder(WebBrowserType, String, String)} to get a
 * builder, or you can equivalently call
 * {@link #getChromeBuilder(String, String)},
 * {@link #getFirefoxBuilder(String, String)}, or
 * {@link #getInternetExplorerBuilder(String, String)}.
 * <p>
 * Calling RemoteBrowserBuilder.getBuilder(BrowserType.CHROME, ...) is
 * equivalent to calling RemoteBrowserBuilder.getChromeBuilder(...).
 * </p>
 */
public class RemoteBrowserBuilder {
	...
	/**
	 * Get a RemoteBrowserBuilder used to construct a RemoteBrowser instance
	 * that helps you to run Selenium tests against a remote Browser running in
	 * a Selenium Grid.
	 * 
	 * @param browserType
	 *            - CHROME, FIREFOX, or IE
	 * @param baseTestUrl
	 *            - base URL of the webapp you are testing, e.g.
	 ...
	 * Get a RemoteBrowserBuilder used to construct a RemoteBrowser instance
	 * that helps you to run Selenium tests against a remote Browser running in
	 * a Selenium Grid. For CHROME browser.
	 * 
	 * @param baseTestUrl
	 *            - base URL of the webapp you are testing, e.g.
	 *            http://my.site.com/base
	 ...
	 * Get a RemoteBrowserBuilder used to construct a RemoteBrowser instance
	 * that helps you to run Selenium tests against a remote Browser running in
	 * a Selenium Grid. For FIREFOX browser.
	 * 
	 * @param baseTestUrl
	 *            - base URL of the webapp you are testing, e.g.
	 *            http://my.site.com/base
	 ...
	 * Get a RemoteBrowserBuilder used to construct a RemoteBrowser instance
	 * that helps you to run Selenium tests against a remote Browser running in
	 * a Selenium Grid. For IE browser.
	 * 
	 * @param baseTestUrl
	 *            - base URL of the webapp you are testing, e.g.
	 *            http://my.site.com/base
	...
	/**
	 * Creates the RemoteBrowser instance, which includes creating the actual
	 * Browser process via the underlying WebDriver.
	 * 
	 * @return - a
