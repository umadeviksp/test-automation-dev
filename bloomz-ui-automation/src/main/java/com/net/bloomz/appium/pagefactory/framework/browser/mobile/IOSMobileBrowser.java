...
import com.net.bloomz.appium.pagefactory.framework.actions.IOSSeleniumActions;
...
/**
 * Known bug of Apple from Xcode 5 and iOS 7.1 Simulator - swipe is not working
 * on simulator. As a workaround, using scrollTo in JavaScript. As in real
 * devices regular swipe works but not scrollTo, using the regular command as
 * well
 */
...
//		webDriver.swipe(startX, startY, endX, endY, duration);
	...
	/**
	 * Uses iOS functionality of automatic scroll to top when clicking status
	 * bar
	 */
