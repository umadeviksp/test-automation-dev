...
public class BrowserUtil {
	...
	/**
	 * Helper to wait until the length of an HTML page (as a String) is stable
	 * for 1 second. Useful to wait for javascript actions that modify the DOM
	 ...
	 *
	 * @param browser
	 *            - a remote browser that is running in a Selenium Grid
